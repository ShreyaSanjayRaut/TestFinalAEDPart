        ...
        if (selectedRowIndex != -1) { // Check if a row is selected
            ...
            if (selectedEmergency != null) {
                ...
                if (org != null) {
                    ...
                    JOptionPane.showMessageDialog(this, "Emergency request sent.");
            
                // ...
            } else {
                JOptionPane.showMessageDialog(this, "No emergency record found in the selected row.");
            }
        } else {
            JOptionPane.showMessageDialog(this, "Please select an emergency record.");
        }
