...
public class LabAssistantWorkAreaPanel extends javax.swing.JPanel {
    ...
    private Lab loggedInlab;
     Timer timer;
    /**
     * Creates new form DoctorWorkAreaJPanel
     */
    public LabAssistantWorkAreaPanel(JPanel workArea, UserAccount account, LabOrganization organization, EcoSystem business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Lab Assistant Dashboard");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/LAB.jpg"))); // NOI18N
    ...
    private void updateProfile() {
        ...
        ManageLabProfile docProfile = new ManageLabProfile(loggedInlab, userAccount);
    ...
    private Lab populateLabUser() {

        LabDirectory directory = organization.getLabDirectory();

        for (Lab lab : directory.getLabList()) {

            System.out.println("labs " + lab.toString());
            if (lab != null && lab.getLabName() != null && lab.getLabName().equals(userAccount.getUsername())) {
                //   System.out.println("lab matches is " + lab.getLabName());
                return lab;
            }
    ...
    private void manageAppointment() {
        ...
        profile.setBackground(new Color(213, 230, 249));
         ...
         ViewRequestJPanel viewRequestPanel = new ViewRequestJPanel(workArea, userAccount, (LabOrganization) organization);


        rightPanel.add(viewRequestPanel);
        CardLayout layout = (CardLayout) rightPanel.getLayout();
        layout.next(rightPanel);
    }
