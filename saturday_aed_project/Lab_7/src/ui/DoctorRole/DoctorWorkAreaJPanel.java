...
public class DoctorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bloodReq = new javax.swing.JPanel();
        ...
        jLabel10.setText("Doctor Dashboard");
        jPanel6.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 30, -1, -1));
        ...
        bloodReq.setBackground(new java.awt.Color(255, 255, 255));
        bloodReq.setForeground(new java.awt.Color(255, 255, 255));
        bloodReq.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        bloodReq.setPreferredSize(new java.awt.Dimension(100, 48));
        bloodReq.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                bloodReqMousePressed(evt);
            }
        });
        bloodReq.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 153, 0));
        jLabel3.setText("Manage Blood Requests");
        bloodReq.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 220, -1));

        Appointments.add(bloodReq, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 240, 60));
        ...
        manageAppointment.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 190, -1));

        Appointments.add(manageAppointment, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 240, 70));
        ...
        Appointments.add(profile, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 240, 50));

        rightPanel.setBackground(new java.awt.Color(250, 249, 251));
        rightPanel.setPreferredSize(new java.awt.Dimension(1024, 900));
        rightPanel.setLayout(new java.awt.CardLayout());

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/doctor.jpg"))); // NOI18N
        jLabel4.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        jLabel4.setMaximumSize(new java.awt.Dimension(1024, 900));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(rightPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 1212, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(rightPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 1008, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    }// </editor-fold>//GEN-END:initComponents

    private void bloodReqMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bloodReqMousePressed
        // TODO add your handling code here:
        //ad  appointments();

        addBloodReq();
    }//GEN-LAST:event_bloodReqMousePressed
    ...
    private javax.swing.JPanel bloodReq;
    ...
    private void updateProfile() {
        ...
        bloodReq.setBackground(new Color(213, 230, 249));
        manageAppointment.setBackground(new Color(213, 230, 249));

        profile.setBackground(new Color(255, 255, 255));
        
        ManageDoctorProfile docProfile = new ManageDoctorProfile(currentDoctor, userAccount);
    ...
    private void manageAppointment() {
        ...
        ManageAppointment map = new ManageAppointment(workArea, userAccount, business, currentDoctor);
    ...
    private void addBloodReq() {
        ...
        bloodReq.setBackground(new Color(255, 255, 255));
        manageAppointment.setBackground(new Color(213, 230, 249));
     
        profile.setBackground(new Color(213, 230, 249));
        
        RequestBlood reqBlood = new RequestBlood(workArea, userAccount, business, currentDoctor);

        rightPanel.add(reqBlood);
        CardLayout layout = (CardLayout) rightPanel.getLayout();
        layout.next(rightPanel);
